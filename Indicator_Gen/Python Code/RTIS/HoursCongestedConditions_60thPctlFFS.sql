...
-- 	SUM(CASE WHEN speed / p.ff_speed_85th60th <= 0.6 THEN 0.25 ELSE 0 END) AS congested_hours, --using manually-determined reference speed since it's missing from some TMCs for no apparent reason, also because don't want to use overnight FF for arterials
