...
if __name__ == '__main__':
    ...
    df_chas['Percent'] = df_chas['Households'] / df_chas.groupby(['County Name', 'name', 'Household Size'])['Households'].transform('sum')
    ...
    for county in counties:
        ...
        for jurisdiction in tqdm(jurisdictions):
            ...
            df_prod = df_chas_sub[df_chas_sub['name'] == jurisdiction].pivot_table(index='Income Level', columns='Household Size', values='Households').reset_index()
            df_pct  = df_chas_sub[df_chas_sub['name'] == jurisdiction].pivot_table(index='Income Level', columns='Household Size', values='Percent'   ).reset_index()
