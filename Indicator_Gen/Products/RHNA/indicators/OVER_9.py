...
if __name__ == '__main__':
    ...
    for county in counties:
        ...
        for jurisdiction in tqdm(jurisdictions):
            ...
            df_prod = df_chas_sub[df_chas_sub['name'] == jurisdiction].pivot_table(index='Cost Burden', columns='Household Size', values='Households').reset_index()
            df_pct  = df_chas_sub[df_chas_sub['name'] == jurisdiction].pivot_table(index='Cost Burden', columns='Household Size', values='Percent').reset_index()
