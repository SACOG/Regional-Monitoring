...
if __name__ == '__main__':
    ...
    df_places   = df_places  .drop(['num_jobs', 'Occupied'], axis=1).rename(columns={'JURIS':'Geography' })
    df_counties = df_counties.drop(['num_jobs', 'Occupied'], axis=1).rename(columns={'COUNTY':'Geography'})
    ...
    for county in counties:
        ...
        df_places_sub   = df_places  [df_places  ['COUNTY'   ] == county].drop('COUNTY', axis=1)
