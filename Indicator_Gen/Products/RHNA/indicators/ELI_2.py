...
if __name__ == '__main__':
    ...
    conditions = [
        ...
        , df_chas['Race Ethnicity'] == 'Pacific Islander alone, non-Hispanic' # TODO: Why am I mapping this to other?
    ...
    for county in counties:
        ...
        for jurisdiction in tqdm(jurisdictions):
            ...
            df_prod = df_chas_sub[df_chas_sub['name'] == jurisdiction].pivot_table(index=['Race/Ethnicity'], columns='Income Level', values='Households').reset_index()
            df_pct  = df_chas_sub[df_chas_sub['name'] == jurisdiction].pivot_table(index=['Race/Ethnicity'], columns='Income Level', values='Percent'   ).reset_index()
