...
path_schools = Path(r'I:/Projects/Warren/Schools_data_update/2024_Data/Data_Cleaning/Sch_Combined')
file_schools = path_schools / 'SACOG_Schools_Merged_Data_Final.csv'
...
path_geo = Path(r'I:\Projects\Josh\Geospatial Data\TIGER\geojson')
file_cdp = path_geo / 'tl_2022_us_place_SACOG.geojson'
