...
if __name__ == '__main__':
    ...
    df_places['Sort'] = pd.Categorical(df_places[variable], ['Female-headed households without children', 'Female-headed households with children'])
    ...
    for county in counties:
        ...
        for jurisdiction in tqdm(jurisdictions, position=0):
            ...
            fig = px.bar(df_plot, x=variable, y=values, color=columns, color_discrete_map=color_map, barmode='group')
