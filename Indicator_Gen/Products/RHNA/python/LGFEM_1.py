...
if __name__ == '__main__':
    ...
    df_places['Sort'] = pd.Categorical(df_places[variable], ['1 person household', '2 person household', '3 person household', '4 person household', '5 or more person household'])
