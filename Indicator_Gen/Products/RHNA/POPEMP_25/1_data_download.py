...
print('Fetching data for 20233...');print(); print()
var_dict_acs5 = c.acs5.get(df_vars_18, geo = {'for': 'tract:*', 'in': sql_query}, year=2023)
print('Result:')
...
var_dict_acs5 = c.acs5.get(df_vars_12, geo = {'for': 'tract:*', 'in': sql_query}, year=2018)
...
# SF3
var_dict_sf3 = c.sf3.get(var_sf3, geo = {'for': 'tract:*', 'in': sql_query}, year=1990)
