...
data['pop00flag'] = np.where((data['pop_00'] > 500), 1, 0) #Might not care about the threshold - this is a problem for areas that grew rapidly in the 2000's.  For example, Elk Grove tract 6067009328 had population of only 39 in 2000, but now has 6379.  Should we really exclude this tract?  Should we only go back to 2010 now?
...
['SMMI', 'ARE', 'LISD', 'AdvG', 'BE', 'SAE', 'EOG', 'OD', 'ARG']
