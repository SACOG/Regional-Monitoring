...
# Crosswalk files
xwalk_90_10 = pd.read_csv(input_path+'crosswalk_1990_2010.csv',dtype={'trtid90':str, 'trtid10':str})
xwalk_00_10 = pd.read_csv(input_path+'crosswalk_2000_2010.csv',dtype={'trtid00':str, 'trtid10':str})
...
def crosswalk_files (df, xwalk, counts, medians, df_fips_base, xwalk_fips_base, xwalk_fips_horizon):
    ...
    df = df.rename(columns = {'FIPS':'trtid_base', xwalk_fips_horizon:'FIPS'})
...
## TODO: not a big fan of naming a dataframe object after a package we have imported
...
## TODO: What is the point setting the "census" object to "df"
...
## TODO: Not a huge fan of the crosswalking zips to tracts
...
## TODO: What is the point setting the "census_zillow" object to "df"
