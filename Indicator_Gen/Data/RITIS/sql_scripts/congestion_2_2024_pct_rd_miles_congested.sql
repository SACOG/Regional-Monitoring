...
INTO #ff_spd_tbl
FROM npmrds_2024_alltmc_txt tmc
	LEFT JOIN npmrds_2024_alltmc_paxtruck_comb tt
...
FROM npmrds_2024_alltmc_paxtruck_comb tt
	JOIN #ff_spd_tbl ff
...
select SUM(miles) from npmrds_2024_alltmc_txt where nhs > 0
